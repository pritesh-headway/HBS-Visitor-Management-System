                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="general-pages">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="userregister.php">Register Company </a></li>
                                <li class="nav-item"> <a class="nav-link" href="user_permission.php"> Company permissions</a></li>
                            </ul>
                        </div>
                    </li>
                    <?php 
